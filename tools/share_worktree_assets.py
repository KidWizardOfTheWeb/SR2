...
DEFAULT_BOOTSTRAP_VERSION = "SLUS-21642-PROTO-070901"
...
FIXED_ASSETS = (
    AssetSpec(os.path.join("orig", "SLUS-21642-PROTO-070901", "SLUS_216.42"), "file"),
    AssetSpec(os.path.join("build", "tools"), "dir"),
    AssetSpec(os.path.join("build", "compilers"), "dir"),
    AssetSpec(os.path.join("build", "binutils"), "dir"),
)
