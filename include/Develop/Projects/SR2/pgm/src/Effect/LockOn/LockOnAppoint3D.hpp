#ifndef LOCKONAPPOINT3D_HPP
#define LOCKONAPPOINT3D_HPP
...
class clsLockOnAppoint3D_Task : public clsBaseLockOn_Task {
public:
    clsLockOnAppoint3D_Task(u32 u32ViewNo, const NNS_VECTORFAST* psPosVecFast, u32 u32CharaNo);
    virtual ~clsLockOnAppoint3D_Task();
    virtual void reset();
    ...
    f32 m_f32MatMotFrame;            // offset 0x60, size 0x4
    u32 m_u32CharaNo;                // offset 0x64, size 0x4

    static clsModelType_OB_TX_MO_MA t_cModel;
};

#endif // LOCKONAPPOINT3D_HPP
