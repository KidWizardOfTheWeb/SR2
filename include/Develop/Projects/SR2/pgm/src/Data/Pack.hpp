...
#ifndef NSP_PACK_ID_ENM_DECLARED
#define NSP_PACK_ID_ENM_DECLARED
namespace nspPackId {
enum enm {
    NONE = -1,
    CHARA_0 = 0,
...
// total size: 0x8
struct stcPackBinHead {
    c8 ac8PackStr[4];      // offset 0x0, size 0x4
    u16 u16AllGroupNum;    // offset 0x4, size 0x2
    u8 u8PackDataRevision; // offset 0x6, size 0x1
    u8 u1NnFlag : 1;       // offset 0x7, size 0x1
    u8 u7Padding : 7;      // offset 0x7, size 0x1
};

// total size: 0x50
class _GearModels {
public:
    clsModelType_OB_TX asModels[9]; // offset 0x0, size 0x48
    void* pvGearPackBuffer;         // offset 0x48, size 0x4
    u16 u16CtrlNo;                  // offset 0x4C, size 0x2
    u16 u16LoadedNum;               // offset 0x4E, size 0x2
};

// total size: 0x284
class _GearModelInfo {
public:
    _GearModels sGearModels[8]; // offset 0x0, size 0x280
    u32 u32DataNum;             // offset 0x280, size 0x4
};

// total size: 0x4
class clsPack : public clsSingleton<clsPack> {
public:
    // total size: 0x28
    struct stcBinInfo {
        nspPackId::enm ePackId; // offset 0x0, size 0x4
        u8* opu8Bin[6];         // offset 0x4, size 0x18
        u8* opu8BinTopAddr;     // offset 0x1C, size 0x4
        u32* opu32OffsetNo;     // offset 0x20, size 0x4
        s32 s32RestBinNum;      // offset 0x24, size 0x4
    };

    // total size: 0x34
    struct stcSetDataDetail {
        u16 u16Type; // offset 0x0, size 0x2
        union {
            u8 uniu8ViewportNum;    // offset 0x2, size 0x1
            u8 uniu8MissionStageNo; // offset 0x2, size 0x1
        };
        u8 u8PortalType;       // offset 0x3, size 0x1
        u32 u32GameModeSwitch; // offset 0x4, size 0x4
        u32 u32Attr;           // offset 0x8, size 0x4
        NNS_VECTOR sPosVec;    // offset 0xC, size 0xC
        NNS_VECTOR sRotVec;    // offset 0x18, size 0xC
        NNS_VECTOR sScaleVec;  // offset 0x24, size 0xC
        u32 u32GroupNum;       // offset 0x30, size 0x4
    };
    ...
    // --- non-weak methods ---
    static void Pack2Set(void* pvAddrI, u32 u32Context, clsTask* pcTaskI);
    void loadGearModels(u32 u32DataIdx, stcBinInfo& rsBinInfo);
    void setPlayerPosition(
        oostd::clsOOVector<stcSetDataDetail*, oostd::clsOOStlAllocator<stcSetDataDetail*> >&
            rvctStarPos);
    static c8* getFileName(nspPackId::enm eTypeIdI, s32 s32No0I, s32 s32No1I, s32 s32No2I);
};

void setPlayerPositionOther(clsOOVector& rvctStarPos);

typedef clsPack::stcBinInfo stcBinInfo;
typedef clsPack::stcSetDataDetail stcSetDataDetail;

// total size: 0x8
struct stcSetData {
    u32 u32AllObjNum;                     // offset 0x0, size 0x4
    u32 u32FileSize;                      // offset 0x4, size 0x4
    stcSetDataDetail oasSetDataDetail[0]; // offset 0x8, size 0x0
};
